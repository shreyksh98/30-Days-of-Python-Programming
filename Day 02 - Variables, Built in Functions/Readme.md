...
age = 260
is_married = True
skills = ['SQL', 'Tableau', 'Statistical Analysis', 'Data Modeling', 'Python']
person_info = {
   'firstname':'Shrey',
   'lastname':'Kshatriya',
   'country':'United States of America',
...
```py
first_name, last_name, country, age, is_married = 'Shrey', 'Kshatriya', 'Jersey City', 260, False
...
first_name = 'Shrey'     # str
last_name = 'Kshatriya'       # str
country = 'United States of America'         # str
city= 'Jersey City'            # str
age = 260                   # int, it is not my real age, don't worry about it

# Printing out types
print(type('Shrey'))     # str
...
print(type({'name':'Shrey','age':250, 'is_married':False}))    # dict
